describe('verify_loginuser_add_product_success_checkout', () => {  
  ...
  it('Login with your user, add 1 item to the basket, click on checkout, add a new address, fill in the address form, click on submit', () => {        
    ...
    //verify the basket has 1 item
    cy.get('.fa-layers-counter.fa-layers-top-right.fa-3x.warn-notification').should('have.text', 1)    
